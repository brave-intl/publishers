...
module Rewards
  class Parameters < Rewards::Client
    ...
    def fallback
      {uphold: {allow: ["AD", "AU", "AR", "AT", "BE", "BR", "BS", "BZ", "CA", "CH", "CL", "CO", "CR", "CY", "CZ", "DK", "EC", "EE", "FI", "FR", "GD", "GT", "GR", "HK", "HN", "HU", "IE", "IS", "IT", "JM", "KY", "LI", "LT", "LV", "LU", "MC", "MT", "MX", "NI", "NO", "NZ", "PE", "PL", "PT", "PY", "SG", "TR", "UY", "ES", "SE", "GB", "US", "UM", "ZA"], block: []}, bitflyer: {allow: ["JP"], block: []}}
    end
  end
end
