...
class PaperTrail::Events::Base
  ...
  def cache_changed_attributes(&block); end
...
class PaperTrail::Rails::Engine < ::Rails::Engine; end
PaperTrail::Rails::Engine::DPR_CONFIG_ENABLED = T.let(T.unsafe(nil), String)
PaperTrail::Rails::Engine::DPR_RUDELY_ENABLING = T.let(T.unsafe(nil), String)
...
class PaperTrail::Request::InvalidOption < ::RuntimeError; end
