...
class CacheUpholdTips
  sig { params(uphold_connection_for_channel_id: T.untyped).returns(CacheUpholdTips) }
  def self.perform_later(uphold_connection_for_channel_id:); end

  sig { params(uphold_connection_for_channel_id: T.untyped).returns(CacheUpholdTips) }
  def self.perform_now(uphold_connection_for_channel_id:); end
