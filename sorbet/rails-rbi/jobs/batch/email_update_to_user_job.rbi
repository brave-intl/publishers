...
class Batch::EmailUpdateToUserJob
  sig { params(publisher_id: T.untyped).returns(Batch::EmailUpdateToUserJob) }
  def self.perform_later(publisher_id:); end

  sig { params(publisher_id: T.untyped).returns(Batch::EmailUpdateToUserJob) }
  def self.perform_now(publisher_id:); end
