...
class ExchangeUpholdCodeForAccessTokenJob
  sig { params(uphold_connection_id: T.untyped).returns(ExchangeUpholdCodeForAccessTokenJob) }
  def self.perform_later(uphold_connection_id:); end

  sig { params(uphold_connection_id: T.untyped).returns(ExchangeUpholdCodeForAccessTokenJob) }
  def self.perform_now(uphold_connection_id:); end
