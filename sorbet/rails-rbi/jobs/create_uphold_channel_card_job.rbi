...
class CreateUpholdChannelCardJob
  sig { params(uphold_connection_id: T.untyped, channel_id: T.untyped).returns(CreateUpholdChannelCardJob) }
  def self.perform_later(uphold_connection_id:, channel_id:); end

  sig { params(uphold_connection_id: T.untyped, channel_id: T.untyped).returns(CreateUpholdChannelCardJob) }
  def self.perform_now(uphold_connection_id:, channel_id:); end
