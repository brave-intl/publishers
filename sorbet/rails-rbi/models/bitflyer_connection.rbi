...
module BitflyerConnection::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: BitflyerConnection).returns(T::Boolean)).returns(T::Array[BitflyerConnection]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(BitflyerConnection::ActiveRecord_Relation) }
...
module BitflyerConnection::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(BitflyerConnection::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end
