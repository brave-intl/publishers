...
module GeminiConnection::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: GeminiConnection).returns(T::Boolean)).returns(T::Array[GeminiConnection]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(GeminiConnection::ActiveRecord_Relation) }
...
module GeminiConnection::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(GeminiConnection::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end
