# This is an autogenerated file for dynamic methods in BrowserUser
# Please rerun bundle exec rake rails_rbi:models[BrowserUser] to regenerate.

# typed: strong
module BrowserUser::ActiveRelation_WhereNot
  sig { params(opts: T.untyped, rest: T.untyped).returns(T.self_type) }
  def not(opts, *rest); end
end

module BrowserUser::GeneratedAttributeMethods
...
module BrowserUser::GeneratedAssociationMethods
...
module BrowserUser::CustomFinderMethods
  sig { params(limit: Integer).returns(T::Array[BrowserUser]) }
  def first_n(limit); end

  sig { params(limit: Integer).returns(T::Array[BrowserUser]) }
  def last_n(limit); end

  sig { params(args: T::Array[T.any(Integer, String)]).returns(T::Array[BrowserUser]) }
  def find_n(*args); end

  sig { params(id: T.nilable(Integer)).returns(T.nilable(BrowserUser)) }
  def find_by_id(id); end

  sig { params(id: Integer).returns(BrowserUser) }
  def find_by_id!(id); end
end

class BrowserUser < Publisher
  include BrowserUser::GeneratedAttributeMethods
  include BrowserUser::GeneratedAssociationMethods
  extend BrowserUser::CustomFinderMethods
  extend BrowserUser::QueryMethodsReturningRelation
  RelationType = T.type_alias { T.any(BrowserUser::ActiveRecord_Relation, BrowserUser::ActiveRecord_Associations_CollectionProxy, BrowserUser::ActiveRecord_AssociationRelation) }

  sig { params(args: T.untyped).returns(BrowserUser::ActiveRecord_Relation) }
...
class BrowserUser::ActiveRecord_Relation < ActiveRecord::Relation
  include BrowserUser::ActiveRelation_WhereNot
  include BrowserUser::CustomFinderMethods
  include BrowserUser::QueryMethodsReturningRelation
  Elem = type_member(fixed: BrowserUser)
...
class BrowserUser::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  include BrowserUser::ActiveRelation_WhereNot
  include BrowserUser::CustomFinderMethods
  include BrowserUser::QueryMethodsReturningAssociationRelation
  Elem = type_member(fixed: BrowserUser)

  sig { params(args: T.untyped).returns(BrowserUser::ActiveRecord_AssociationRelation) }
  def admin(*args); end
...
class BrowserUser::ActiveRecord_Associations_CollectionProxy < ActiveRecord::Associations::CollectionProxy
  include BrowserUser::CustomFinderMethods
  include BrowserUser::QueryMethodsReturningAssociationRelation
  Elem = type_member(fixed: BrowserUser)
  ...
  sig { params(records: T.any(BrowserUser, T::Array[BrowserUser])).returns(T.self_type) }
  def <<(*records); end
...
module BrowserUser::QueryMethodsReturningRelation
  sig { returns(BrowserUser::ActiveRecord_Relation) }
  def all; end

  sig { params(block: T.nilable(T.proc.void)).returns(BrowserUser::ActiveRecord_Relation) }
  ...
  sig { params(block: T.proc.params(e: BrowserUser).returns(T::Boolean)).returns(T::Array[BrowserUser]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(BrowserUser::ActiveRecord_Relation) }
  def select_columns(*args); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(BrowserUser::ActiveRecord_Relation) }
  ...
  sig do
    params(
      ...
      block: T.nilable(T.proc.params(e: BrowserUser::ActiveRecord_Relation).void)
    ).returns(ActiveRecord::Batches::BatchEnumerator)
  end
  def in_batches(of: 1000, start: nil, finish: nil, load: false, error_on_ignore: nil, &block); end
end

module BrowserUser::QueryMethodsReturningAssociationRelation
  sig { returns(BrowserUser::ActiveRecord_AssociationRelation) }
  def all; end
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(BrowserUser::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(BrowserUser::ActiveRecord_AssociationRelation) }
  def extending(*args, &block); end
  ...
  sig do
    params(
      ...
      load: T.nilable(T::Boolean),
      error_on_ignore: T.nilable(T::Boolean),
      block: T.nilable(T.proc.params(e: BrowserUser::ActiveRecord_AssociationRelation).void)
    ).returns(ActiveRecord::Batches::BatchEnumerator)
  end
  def in_batches(of: 1000, start: nil, finish: nil, load: false, error_on_ignore: nil, &block); end
end
