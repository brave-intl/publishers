...
(cd nextjs && NODE_TLS_REJECT_UNAUTHORIZED=0 TEST_MODE=true TEST_MODE_PUBLISHERS_HOST=localhost:4000 TEST_MODE_NEXT_HOST=localhost:5001 NODE_ENV=development npm run dev) &
