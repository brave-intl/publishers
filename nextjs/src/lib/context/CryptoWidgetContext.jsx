...
export function CryptoWidgetProvider({ children }) {
  ...
  return (
    <CryptoWidgetContext.Provider value={{ currentChain, setCurrentChain, ratios, setRatios, displayChain, setDisplayChain, currentAmount, setCurrentAmount, errorTitle, setErrorTitle, errorMsg, setErrorMsg, isSuccessView, setIsSuccessView, isTryBraveModalOpen, setIsTryBraveModalOpen }}>
      {children}
