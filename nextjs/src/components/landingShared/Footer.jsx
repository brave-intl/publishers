...
export default function Footer() {
  ...
  return (
    <div
      className={`${styles['box']} ${styles['footer']} px-[24px] py-[12px] sm:px-[48px] sm:py-[24px]`}
    >
      <div className={`${styles['box']} flex-row p-[8px] sm:p-0`}>
        <a
          rel='noopener'
          className='text-[12px] text-[#7c7d8c]'
          href={t('landingPages.footer.oneHref')}
        >
        ...
        <a
          rel='noopener'
          className='text-[12px] text-[#7c7d8c]'
          label={t('landingPages.footer.two')}
          href={t('landingPages.footer.twoHref')}
        >
        ...
        <a
          rel='noopener'
          className='text-[12px] text-[#7c7d8c]'
          href={t('landingPages.footer.threeHref')}
        >
      ...
      {locale !== 'ja' && (
        <a
          className={`${styles['box']} flex-row p-[8px] sm:p-0`}
