    ...
    <div className={`${styles['box']} flex-col`}>
      <div className={`${styles['box']} ${styles['carousel-container']}`}>
        <div className={`${styles['box']} ${styles['carousel-quote']}`}>
          <h3 className={`${styles['spotlight-heading']}`}>{quote}</h3>
          <p className='my-[1em] font-semibold text-[#808080]'>{text}</p>
        </div>
        <a className={`${styles['box']} ${styles['carousel-img']}`} href={link}>
          <img
            src={card.webp.src}
            className='h-full w-full flex-[1_1_0%] overflow-hidden object-contain'
            alt={alt}
...
export default function Spotlight() {
  ...
  return (
    <div className={`${styles['box']} flex-col items-center p-[48px]`}>
      <div
        className={`${styles['box']} w-full max-w-[1200px] flex-col items-center`}
      >
        <div className={`${styles['box']} flex-col items-center p-[24px]`}>
          <h3 className={`${styles['spotlight-heading']} my-[1em]`}>
            {t('landingPages.spotlight.heading')}
          </h3>
          <p className='my-[1em] text-center leading-[1.6em] text-[#808080]'>
