      ...
      <div className={`${styles['nav-container']}`}>
        <Link href='/'>
          <img
            ...
            alt={t('landingPages.nav.logoAlt')}
          />
        </Link>
        <ButtonMenu aria-label='Nav'>
          <span slot='anchor-content'>
            <Icon className='text-white' name='hamburger-menu' />
          </span>
          <leo-menu-item>
            <Link href='/sign-up'>{t('landingPages.nav.signup')}</Link>
          </leo-menu-item>
          <leo-menu-item>
            <Link href='/log-in'>{t('landingPages.nav.login')}</Link>
          </leo-menu-item>
        </ButtonMenu>
      </div>
    </div>
