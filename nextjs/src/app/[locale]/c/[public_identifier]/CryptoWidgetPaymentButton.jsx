...
export default function CryptoWidgetPaymentButton({ previewMode, addresses, cryptoConstants }) {
  ...
  const { currentChain, currentAmount, setIsSuccessView, setErrorMsg, setErrorTitle, setIsTryBraveModalOpen } =
