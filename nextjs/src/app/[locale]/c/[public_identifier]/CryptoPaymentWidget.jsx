...
export default function CryptoPaymentWidget({title, cryptoAddresses, cryptoConstants, previewMode}) {
  ...
  const { currentChain, setCurrentChain, setRatios, displayChain, currentAmount, errorMsg, setErrorMsg, errorTitle, setErrorTitle, isSuccessView, setIsSuccessView, isTryBraveModalOpen } =
    ...
    return (
      <div className={`${styles['crypto-widget-wrapper']}`}>
        ...
        <div className={`${styles['payment-buttons']}`}>
          <CryptoWidgetPaymentButton previewMode={previewMode} cryptoConstants={cryptoConstants} addresses={addresses} />
          <a 
