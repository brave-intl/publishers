    ...
    <div>
      <div className={`${styles['qr-title']}`}>
        ...
        {displayChain.includes('BAT') ? (
          <div className={`${styles['qr-subtitle']} default-regular`}>
            {t('publicChannelPage.QRBatText', {
              chain: t(`publicChannelPage.${chain}`),
            })}
          </div>
        ) : (
          <div className={`${styles['qr-subtitle']} default-regular`}>
      ...
      <div
        id='qr-wrapper'
        ref={ref}
        className={`text-center ${styles['qr-box']}`}
      ></div>
      <div className={`${styles['qr-text']}`}>
        <div className={`${styles['qr-text-item']}`}>
          <Icon
            name='smartphone-laptop'
            className={`${styles['qr-text-icon']} color-interactive pr-3`}
          />
        </div>
        <div className={`${styles['qr-text-item']}`}>
