...
export default function CryptoWidgetAmountSelect({ clearError, ethAddress, solAddress }) {
  ...
  const { currentChain, setCurrentChain, ratios, displayChain, setDisplayChain, currentAmount, setCurrentAmount } =
