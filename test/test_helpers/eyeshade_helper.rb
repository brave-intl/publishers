...
module EyeshadeHelper
  def stub_eyeshade_transactions_response(publisher:, transactions: [])
    stub_request(:get, "#{Rails.configuration.pub_secrets[:api_eyeshade_base_uri]}/v1/accounts/#{URI.encode_www_form_component(publisher.owner_identifier)}/transactions")
  ...
  def stub_eyeshade_balances_response(publisher:, balances: [])
    ...
    stub_request(:post, "#{Rails.configuration.pub_secrets[:api_eyeshade_base_uri]}/v1/accounts/balances")
