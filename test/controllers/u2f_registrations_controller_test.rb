...
class U2fRegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "index requires authentication" do
    get u2f_registrations_path

    assert_redirected_to root_path
  end

  test "index renders when authenticated with new key form" do
  ...
  test "U2F registration creation" do
    ...
    assert_redirected_to u2f_registrations_path, "redirects to u2f_registrations page"
  end

  test "index renders registered keys" do
