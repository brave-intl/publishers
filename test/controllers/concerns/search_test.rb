...
class SearchTest < ActionDispatch::IntegrationTest
  ...
  before do
    @prev_youtube = Rails.application.credentials[:youtube_api_key]
  end

  after do
    Rails.application.credentials[:youtube_api_key] = @prev_youtube
  end
  ...
  describe "extract_channel_from_user" do
    it "extracts channel from username" do
      Rails.application.credentials[:youtube_api_key] = nil
    ...
    describe "extract channel from user mock" do
      ...
      it "returns empty string when user is not found" do
        Rails.application.credentials[:youtube_api_key] = "key"
