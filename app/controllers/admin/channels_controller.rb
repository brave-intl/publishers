...
module Admin
  class ChannelsController < AdminController
    ...
    def index
      ...
      @last_ofac_list_run = ServiceRun.last_success_at(ParseOfacListService)
      @last_banned_address_run = ServiceRun.last_success_at(Wallet::DisconnectInvalidP2pAddressService)
