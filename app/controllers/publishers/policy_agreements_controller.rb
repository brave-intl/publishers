class Publishers::PolicyAgreementsController < PublishersController
  ...
  def create
    ...
    result = PolicyAgreement.create(
      ...
      accepted_publisher_list_policy: create_params[:accepted_publisher_list_policy] == 'true'
    )
  ...
  def create_params
    params.require(:policy_agreement)
      .permit(:accepted_publisher_tos, :accepted_publisher_privacy_policy, :accepted_publisher_list_policy)
  end
end
