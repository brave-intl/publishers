...
# /api/v3_1/public/channels
# V3.1 Version of Channels list
#
...
#   excluded (boolean),
#   publisher ads opted in? (boolean),
#   wallet address,
#   site_banner details
# ]
#
# ex.
# [
#   ["brave.com", "verified", false, true, 1234-abcd-5678-efgh, {title: 'Hello', description: 'world'...}],
#   ["google.com", "", true, false, {}, 1234-abcd-5678-efgh],
#   ["us.gov", "", true, false, {}, 1234-abcd-5678-efgh]
# ]

class JsonBuilders::ChannelsJsonBuilderV3P1
