class Channel < ApplicationRecord
  ...
  validates :verification_details, inclusion: {
    in: %w(support_queue domain_not_found connection_failed too_many_redirects no_txt_records token_incorrect_dns token_not_found_dns token_not_found_public_file no_https)
  }, allow_nil: true
