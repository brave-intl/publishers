...
class Channel < ApplicationRecord
  ...
  validate :site_channel_details_brave_publisher_id_unique_for_publisher, if: -> {
                                                                                T.bind(self, Channel)
