...
class VimeoChannelDetails < BaseChannelDetails
  ...
  def omniauth_url
    "https://api.vimeo.com/oauth/authorize?response_type=code&client_id=#{Rails.application.credentials[:vimeo_client_id]}&redirect_uri=#{Rails.application.credentials[:vimeo_redirect_uri]}/publishers/home&state=1"
  end
