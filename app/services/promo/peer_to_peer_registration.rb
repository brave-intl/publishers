...
class Promo::PeerToPeerRegistration < BaseApiClient
  ...
  def initialize(publisher_id:, promo_campaign_id:, promo_id: active_promo_id)
  ...
  def perform
    ...
    response = connection.put do |request|
      ...
      request.url("/api/2/promo/referral_code/owner/#{@publisher.owner_identifier}?peer_to_peer=true")
    end
