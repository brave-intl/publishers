...
describe("Wallet", () => {
  let walletData = {
    ...
    action: null,
    channel_balances: {
      "youtube#channel:UCtsfHRe2WQnkNH5WYJWL-Yw": {
        rates: {
          BTC: 5.418424016883016e-5,
          ETH: 0.000795331082073117,
          USD: 0.2363863335301452,
    ...
    last_settlement_balance: {
      ...
      default_currency: "GBP",
      amount_bat: "75.62",
      timestamp: 1544158800,
      settlement_currency: "ETH",
      amount_settlement_currency: "0.06"
    }
  };
  ...
  it("initializes balance info from json", () => {
    ...
    let channelBalance =
      wallet.channelBalances["youtube#channel:UCtsfHRe2WQnkNH5WYJWL-Yw"];
