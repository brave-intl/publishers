...
export default class ReferralsCard extends React.Component<IReferralsCardProps> {
      ...
      <Wrapper>
        ...
        <Row title>
          ...
          <ContentWrapper>
            ...
            <TextWrapper created>
              ...
              <Text date>{processCreatedAt(this.props.campaign.created_at)}</Text>
            </TextWrapper>
          </ContentWrapper>
        </Row>
        ...
        <Row stats>
          <TextWrapper stats>
            ...
            <Text stat>{processDownloads(this.props.campaign.promo_registrations)}</Text>
          </TextWrapper>
          <TextWrapper stats>
            <Text header>{locale.installs}</Text>
            <Text stat>{processInstalls(this.props.campaign.promo_registrations)}</Text>
          </TextWrapper>
          <TextWrapper stats>
            <Text header>{locale.thirtyDay}</Text>
            <Text use>{processThirtyDayUse(this.props.campaign.promo_registrations)}</Text>
          </TextWrapper>
        </Row>
        ...
        <Row total>
          ...
          <TextWrapper total>
            <Text codes>{processTotalCodes(this.props.campaign.promo_registrations)}</Text>
          </TextWrapper>
          <IconWrapper carat>
