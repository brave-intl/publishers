...
export default class BannerPreview extends React.Component {
  ...
  handleClose(){
    ...
    renderBannerEditor(this.props.preferredCurrency, this.props.conversionRate, this.props.defaultBannerMode, this.props.defaultBanner, this.props.channelBanners, "Editor");
    setTimeout(function(){
