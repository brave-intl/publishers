...
function checkUpholdStatus() {
  ...
  return fetch("./uphold_status", options)
    ...
    .then(function(body) {
      ...
      let timedOut = checkUpholdStatusCount >= 2;
      console.log(body);
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (upholdStatusElement.classList.contains("uphold-processing")) {
    checkUpholdStatusInterval = window.setTimeout(checkUpholdStatus, 2000);
  } else if (
  ...
  let showContactPhoneSeparator = document.getElementById(
    "show_contact_phone_separator"
  );
