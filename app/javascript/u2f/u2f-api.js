...
// Added by Brave to ensure this code only runs in Chrome. Other platforms
// (like IE11) do not support this API or implement it completely and do
// not require this file (Firefox Nightly with a flag).
if (!window.u2f && navigator.userAgent.indexOf("Chrome") != -1) {
  /**
  ...
  u2f.sign = function (
    ...
    var callback = applyIncompleteImplementationTimeout(
      _callback,
      INCOMPLETE_IMPLEMENTATION_TIMEOUT,
    );
